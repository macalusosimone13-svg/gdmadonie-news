...
export default function AdminRoute({ children }) {
  ...
  useEffect(() => {
    getCurrentUser()
      .then((u) => setState({ loading: false, authed: !!u, isAdmin: u?.role === 'admin' }))
  ...
  if (!state.isAdmin) {
    return (
      <div className="text-center py-20 px-4">
        <p className="text-slate-600 mb-4 font-medium">Accesso riservato alla segreteria (ruolo admin).</p>
